...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_RAISE] = LAYOUT(
		...
		_______, _______, _______, _______, _______, _______, _______, KC_BSLS, KC_LBRC, KC_RBRC,          _______, 
	...
	[_LOWER] = LAYOUT(
		...
		_______, _______, _______, _______, _______, _______, _______, KC_PIPE, KC_LCBR, KC_RCBR,          _______, 
		         _______, _______,          _______, _______, _______,          _______, _______),
