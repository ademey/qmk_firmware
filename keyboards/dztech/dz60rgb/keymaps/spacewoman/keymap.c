...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT( /* Base */
    ...
    KC_LSFT,   KC_Z,        KC_X,        KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,  RSFT_T(KC_SLSH), KC_UP,             MO(_FN),
    KC_LCTL,   KC_LGUI,     KC_LALT,                         FN_SPC,             KC_RALT,  MO(_CL),           KC_LEFT,         KC_DOWN,           KC_RGHT
  ),
  ...
  [_MAC] = LAYOUT( /* Base */
    ...
    KC_LSFT,   KC_Z,        KC_X,        KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,  RSFT_T(KC_SLSH), KC_UP,             MO(_FN),
    KC_LCTL,   KC_LALT,     KC_LGUI,                         FN_SPC,             KC_RGUI,  MO(_CL),           KC_LEFT,         KC_DOWN,           KC_RGHT
  ),
  ...
  [_CL] = LAYOUT( /* Function */
    ...
    _______,   XXXXXXX,     XXXXXXX,     XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,         XXXXXXX,           XXXXXXX,
    _______,   _______,     _______,                         XXXXXXX,            XXXXXXX,  XXXXXXX,           DF(_BL),         DF(_MAC),          XXXXXXX
  ),
