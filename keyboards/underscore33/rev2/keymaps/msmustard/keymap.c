...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUM_SYM] = LAYOUT_33_big_space(
    ...
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_MINS,  KC_EQL,  KC_SCLN, KC_QUOT,
    KC_LSFT,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_BSLS,  KC_LBRC, KC_RBRC, _______,
                        KC_TRNS,  KC_TRNS,   KC_TRNS
  ),

  [_NAV] = LAYOUT_33_big_space(
    KC_MUTE,  KC_VOLD,  KC_VOLU,  XXXXXXX,   XXXXXXX,  XXXXXXX,   KC_HOME,  KC_UP,    KC_END,  XXXXXXX,
    KC_MPRV,  KC_MPLY,  KC_MNXT,  XXXXXXX,   XXXXXXX,  XXXXXXX,   KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_END,
